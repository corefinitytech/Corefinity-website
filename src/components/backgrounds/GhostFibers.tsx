...
/**
 * LOOK B: twisting, glowing fiber threads. Ported from React Bits
 * (https://reactbits.dev/backgrounds/ghost), by David Haz, MIT + Commons
 * Clause v1.0 — free to use as part of a product/website (this), not to be
 * resold or redistributed as a standalone component. Copyright notice kept
 * per that license's terms.
 *
