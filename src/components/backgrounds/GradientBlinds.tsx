...
/**
 * A rotated color gradient sliced into venetian-blind stripes, with a
 * cursor-following spotlight reveal blended over the surface below via
 * mix-blend-mode. Ported from React Bits
 * (https://reactbits.dev/backgrounds/gradient-blinds), by David Haz, MIT +
 * Commons Clause v1.0 — free to use as part of a product/website (this), not
 * to be resold or redistributed as a standalone component. Copyright notice
 * kept per that license's terms.
 *
 * Copyright (c) 2026 David Haz
 *
 * Ported as-is apart from: the "use client" directive Next's App Router
 * requires, and this header. Colors are driven by our palette at the call
 * site rather than the component's own defaults.
 */
